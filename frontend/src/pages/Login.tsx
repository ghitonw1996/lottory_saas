  ...
  // ----------------------------------------------------
    ...
    return (
        ...
        >
            ...
            <div 
                className={`relative z-10 w-[90%] sm:w-full p-6 sm:p-8 transition-all duration-500
                ...
                style={{ 
                    ...
                    width: `${config.box_style?.width || 400}px`,
                    minHeight: `${config.box_style?.height || 400}px`,
